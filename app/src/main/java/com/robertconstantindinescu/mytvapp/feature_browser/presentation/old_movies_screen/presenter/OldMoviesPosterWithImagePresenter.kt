package com.robertconstantindinescu.mytvapp.feature_browser.presentation.old_movies_screen.presenter
...
class OldMoviesPosterWithImagePresenter: Presenter() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, item: Any?) {
        val movie = item as SharedOldMovie
